...
public class Toy implements Comparable<Toy>{
    ...
    public String toString() {
        return  String.format("id:%d %s, процентная вероятность %.1f, колличество призов %d, разряднсть редкости %.2f",this.id, this.name,this.chanceWeight,this.quantity,this.chance );
    }
